...
# string_adder("Emilio", "Estever")   => "Emilio Estever"
# string_adder()                      => " "
...
# print(string_adder("Hello", "igt"))
# print(string_adder("Emilio", "Estever"))
# print(string_adder())
# print(string_adder("Tiger"))

hello = input("If you say hi to me I will say hi back: ")
hello2 = "hello"
print(len(hello2)) 