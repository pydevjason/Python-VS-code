# class names will always be spelled with a capital first letter and will using camelCase syntax.  class names will always refer to one entity and be singular not plural.
